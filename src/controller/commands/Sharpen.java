...
/**
 * A command to perform sharpen operation.
 */
public class Sharpen extends AbstractCommand {

  /**
   * Initialize a sharpen command.
   *
   ...
   */
  public Sharpen(String[] operationParameters) throws IllegalArgumentException {

    this.operationParameters = operationParameters;
    this.numParameters = new int[]{2,4};
    this.commandName = "sharpen";
  ...
  public void execute(ImageModel model) throws IllegalArgumentException {
    ...
    try {
      ...
      model.sharpen(operationParameters[0], operationParameters[1], splitPercent);
    } catch (Exception e) {
