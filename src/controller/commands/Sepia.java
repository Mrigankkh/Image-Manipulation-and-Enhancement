...
/**
 * A command to perform sepia operation.
 */
public class Sepia extends AbstractCommand {

  /**
   * Initialize a sepia command.
   *
   ...
   */
  public Sepia(String[] operationParameters) throws IllegalArgumentException {

    this.operationParameters = operationParameters;
    this.numParameters = new int[]{2, 4};
    this.commandName = "sepia";
  ...
  public void execute(ImageModel model) throws IllegalArgumentException {
    ...
    try {
      ...
      model.sepia(operationParameters[0], operationParameters[1], splitPercent);
    } catch (Exception e) {
