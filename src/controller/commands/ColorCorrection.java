...
/**
 * A command to color correct an image.
 */
public class ColorCorrection extends AbstractCommand {

  /**
   * Initialize a command to color correct an image.
   *
   ...
   */
  public ColorCorrection(String[] operationParameters) throws IllegalArgumentException {

    this.operationParameters = operationParameters;
    this.numParameters = new int[]{2, 4};
    this.commandName = "color correction";
  ...
  public void execute(ImageModel model) throws IllegalArgumentException {
    ...
    try {
      ...
      model.colorCorrection(operationParameters[0], operationParameters[1],
          splitPercent);
    } catch (Exception e) {
